        ...
        <div className="flex w-full min-h-screen">
          ...
          <div className="sticky top-0 bg-white p-6 border-r-2 md:w-1/5 md:max-h-screen md:overflow-y-auto ml-6 mt-2">
            ...
            <div className="flex flex-col">
              <Link
                href="#section-1"
                className="text-left italic underline pb-2"
              >
                What is Arthas AI?
              </Link>
              <Link
              ...
              <Link href="#section-5" className="text-left italic underline">
                FAQ
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white p-6 w-full md:w-4/5 ml-6 mt-2 mr-6">
            ...
            <p className="text-left pb-4">
              ...
              engine that transcends traditional keyword searches. Our tool
              makes finding information faster and easier by understanding what
              you're really looking for. This means less time spent searching
              and more time doing what matters. Our aim is to make research
              simpler and more efficient than ever before, moving beyond what
              traditional search engines offer.`}
            </p>
            ...
            <p className="text-left pb-4">
              ...
              queries, ensuring you find the most relevant academic resources.
              Beyond a mere search tool, our platform integrates a text editor
              for seamless annotation and review of these papers, all within the
              same application. Our solution is tailored to enhance productivity
              and insight for scholars, researchers, and students.
            </p>
            ...
            <p className="text-left pb-4 px-4">
              ...
              search! Tailored for searching academic research papers, our
              engine doesn't just find keywords; it understands your research
              needs, connecting you with the papers most relevant to your
              academic inquiries.`}
            </p>
            ...
            <p className="text-left pb-4 px-4">
              Our integrated text editor is designed for easy annotation,
              organization, and editing. It works seamlessly within the
              platform, ensuring your thoughts are captured alongside your
              sources. It includes annotation features such as: bolding titles,
              text Size Increase, highlighting, color coding, and ability
              blocks.
            </p>
            ...
            <p className="text-left pb-4 px-4">
              {`Need a Study Buddy? Use our AI Chatbot as your intelligent
              assistant, ready to generate summaries, suggest citations, and
              offer insights on your findings! It's like having a research
              partner that's well-versed in every subject.`}
            </p>
            ...
            <h2
              id="section-5"
              className="text-left font-medium text-2xl pb-4 pt-2"
            >
              FAQ
            </h2>
            <Accordion className="pb-4 px-4 " type="single" collapsible>
              ...
              >
                <AccordionTrigger>
                  How does the AI search engine work?
                </AccordionTrigger>
                <AccordionContent>
                  Our search engine uses deep learning to understand the context
                  of your search query. It then suggests research papers and
                  articles that are closely related to your topic, offering you
              ...
              >
                <AccordionTrigger>
                  Can I save and annotate papers directly on the platform?
                </AccordionTrigger>
                <AccordionContent>
                  Yes. Our integrated text editor allows you to save, annotate,
              ...
              >
                ...
                <AccordionContent>
                  Absolutely! Our platform caters to a wide range of academic
